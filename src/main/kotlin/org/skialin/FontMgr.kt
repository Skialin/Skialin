...
class FontMgr internal constructor(ptr: Long) : Managed(ptr, FontMgrNative::nRelease) {
    ...
    fun matchFamilyStyle(familyName: String?, style: FontStyle = FontStyle.NORMAL): Typeface? {
...
private object FontMgrNative {
    ...
    external fun nFamilyName(ptr: Long, index: Int): String
    external fun nMatchFamilyStyle(ptr: Long, familyName: String?, weight: Int, width: Int, slant: Int): Long
    external fun nMakeFromData(ptr: Long, dataPtr: Long, ttcIndex: Int): Long
    external fun nMakeFromFile(ptr: Long, path: String, ttcIndex: Int): Long
}
