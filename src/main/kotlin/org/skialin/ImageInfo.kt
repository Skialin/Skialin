...
class ImageInfo internal constructor(ptr: Long) : Managed(ptr, ImageInfoNative::nRelease) {
    ...
    fun withWH(width: Int, height: Int): ImageInfo = ImageInfo(ImageInfoNative.nWithWH(nativePtr, width, height))
    ...
    companion object {
        ...
        fun makeN32Premul(width: Int, height: Int): ImageInfo = make(width, height, ColorType.N32, AlphaType.PREMUL)
    }
}
...
private object ImageInfoNative {
    ...
    external fun nMake(width: Int, height: Int, colorType: Int, alphaType: Int, colorSpacePtr: Long): Long
    ...
    external fun nComputeByteSize(ptr: Long, rowBytes: Long): Long
    external fun nValidRowBytes(ptr: Long, rowBytes: Long): Boolean
    external fun nWithWH(ptr: Long, width: Int, height: Int): Long
    external fun nWithColorType(ptr: Long, colorType: Int): Long
    external fun nWithAlphaType(ptr: Long, alphaType: Int): Long
    external fun nWithColorSpace(ptr: Long, colorSpacePtr: Long): Long
