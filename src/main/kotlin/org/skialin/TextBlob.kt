...
class TextBlob internal constructor(ptr: Long) : Managed(ptr, TextBlobNative::nRelease) {
    ...
    companion object {
        ...
        fun makeFromText(text: String, font: Font, encoding: Encoding = Encoding.UTF8): TextBlob? {
         ...
         */
        fun makeFromPosTextH(text: String, xpos: FloatArray, constY: Float, font: Font, encoding: Encoding = Encoding.UTF8): TextBlob? {
         ...
         */
        fun makeFromPosText(text: String, pos: Array<Point>, font: Font, encoding: Encoding = Encoding.UTF8): TextBlob? {
            val flat = FloatArray(pos.size * 2)
            pos.forEachIndexed { i, p -> flat[i * 2] = p.x; flat[i * 2 + 1] = p.y }
...
private object TextBlobNative {
    ...
    external fun nFromText(text: String, fontPtr: Long, encoding: Int): Long
    external fun nFromPosTextH(text: String, xpos: FloatArray, constY: Float, fontPtr: Long, encoding: Int): Long
    external fun nFromPosText(text: String, pos: FloatArray, fontPtr: Long, encoding: Int): Long
    external fun nRelease(ptr: Long)
    external fun nUniqueId(ptr: Long): Int
    external fun nBounds(ptr: Long, out: FloatArray)
}
