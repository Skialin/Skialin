...
object ColorMatrix {
    ...
    fun makeScale(
        ...
        b: Float,
        a: Float = 1f,
    ): FloatArray = ColorMatrixNative.nScale(r, g, b, a)
    ...
    fun postTranslate(
        ...
        db: Float,
        da: Float,
    ): FloatArray = ColorMatrixNative.nPostTranslate(mat20, dr, dg, db, da)

    /** `result = a * b` (`a` is applied after `b`). */
    fun concat(
        a: FloatArray,
        b: FloatArray,
    ): FloatArray = ColorMatrixNative.nConcat(a, b)
}
